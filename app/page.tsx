...
const services = [
  {
    ...
    desc: "Custom web applications built with modern frameworks, optimized for performance and experience.",
  },
  {
    colorHex: "#8b5cf6",
    iconPath:
    ...
    title: "Mobile Apps",
    desc: "Native and cross-platform apps that engage users and deliver seamless, polished experiences.",
  },
  {
    colorHex: "#10b981",
    iconPath:
    ...
    desc: "Data-driven strategies that increase visibility and drive real conversions across every channel.",
  },
  {
    colorHex: "#06b6d4",
    iconPath:
  ...
  },
  {
    ...
    desc: "Turn raw data into actionable insights with advanced analytics and beautiful dashboards.",
  },
  {
    colorHex: "#f59e0b",
    iconPath:
    ...
    title: "IT Consulting",
    desc: "Strategic guidance to optimize your technology decisions and future-proof your infrastructure.",
  },
];
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 py-16 md:py-24 max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative h-[420px] sm:h-[500px] lg:h-[560px] rounded-3xl overflow-hidden bg-gray-900 shadow-2xl ring-1 ring-white/10">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-emerald-500/10 rounded-full blur-2xl" />
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 md:py-24 max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">
            A comprehensive range of IT services designed to move your business
            forward.
          </p>
        </div>
